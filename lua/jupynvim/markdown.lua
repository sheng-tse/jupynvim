...
function M.setup_hl()
  ...
  hl(0, HL.H1,          { default = true, fg = "#7aa2f7", bold = true })
  hl(0, HL.H2,          { default = true, fg = "#bb9af7", bold = true })
  hl(0, HL.H3,          { default = true, fg = "#9ece6a", bold = true })
  hl(0, HL.H4,          { default = true, fg = "#e0af68", bold = true })
  hl(0, HL.H5,          { default = true, fg = "#7dcfff", bold = true })
  hl(0, HL.H6,          { default = true, fg = "#a9b1d6", bold = true })
  hl(0, HL.Bold,        { default = true, fg = "#c0caf5", bold = true })
  hl(0, HL.Em,          { default = true, fg = "#c0caf5", italic = true })
  hl(0, HL.Code,        { default = true, fg = "#9ece6a", bg = "#1f2335" })
  hl(0, HL.Link,        { default = true, fg = "#7dcfff", underline = true })
  hl(0, HL.Quote,       { default = true, fg = "#737aa2", italic = true })
  hl(0, HL.Bullet,      { default = true, fg = "#7aa2f7", bold = true })
  hl(0, HL.HR,          { default = true, fg = "#414868" })
  hl(0, HL.Math,        { default = true, fg = "#7dcfff", italic = true })
  hl(0, HL.MathBlock,   { default = true, fg = "#7dcfff", bold = true, bg = "#1f2335" })
  hl(0, HL.Strike,      { default = true, fg = "#565f89", strikethrough = true })
  hl(0, HL.Check,       { default = true, fg = "#9ece6a", bold = true })
  hl(0, HL.TableBorder, { default = true, fg = "#414868" })
  hl(0, HL.TableHead,   { default = true, fg = "#7aa2f7",  bold = true })
end
